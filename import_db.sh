...
DATABASE_NAME="mocljudem"
K8S_NAMESPACE="mocljudem"
SECRETS_NAME="mocljudem-secrets"
...
# docker container exec -i $(docker compose ps -q db) psql -U mocljudem mocljudem < db.dump
